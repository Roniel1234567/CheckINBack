...
// Get evaluaciones por pasantía
router.get('/porPasantia/:id', async (req: Request, res: Response) => {
    await getEvaluacionesPorPasantia(req, res);
});
